            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0 overflow-hidden">
                    ...
                    <div class="row g-0 border-bottom">
                        ...
                        <div class="col-4 p-3 d-flex justify-content-center align-items-center gap-2 border-end
                            ...
                            <a href="{{Route('biblioteca')}}" class="text-decoration-none fw-medium {{ request()->routeIs('biblioteca') ? 'text-white' : 'text-dark' }}">Biblioteca</a>
                        </div>
                        ...
                        <div class="col-4 p-3 d-flex justify-content-center align-items-center gap-2 border-end
                            ...
                            <a href="{{Route('wishlist')}}" class="text-decoration-none fw-medium {{ request()->routeIs('wishlist') ? 'text-white' : 'text-dark' }}">Wishlist</a>
                        </div>

                        <div class="col-4 p-3 d-flex justify-content-center align-items-center gap-2
                             {{ request()->routeIs('myProfile') ? 'bg-primary text-white' : 'bg-white hover-bg-gray text-dark' }}">

                            <span class="material-symbols-outlined">settings</span>
                            <a href="{{Route('myProfile')}}" class="text-decoration-none fw-bold {{ request()->routeIs('myProfile') ? 'text-white' : 'text-dark' }}">Account Details</a>
                        </div>
                    </div>
